...
- (instancetype)initWithTitles:(NSArray <NSString *>*)titleItems layoutStyle:(VScrollMenuLayoutStyle)style {
    ...
    if (self) {
        //默认设置
        _bgColor            = kRGBHex(0xffffff);
        _lineSelectedColor  = kRGBHex(0x4A90E2);
        _textNormalColor    = kRGBHex(0xAFAFB3);
        _textSelectedColor  = kRGBHex(0x4A90E2);
